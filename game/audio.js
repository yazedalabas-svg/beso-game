...
export class Soundscape {
 ...
 preloadEnding(id){this.releaseSamples();const count={truth:18,comedy:7,loop:8,secret:8}[id]||0;this.preloadNames([`ending-${id}`,...Array.from({length:count},(_,i)=>`jojo-${id}-${i}`)]);}
