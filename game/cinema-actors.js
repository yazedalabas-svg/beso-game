...
export function pose(root,kind,t,dt=1/60){
 ...
 if(kind==='challenge'||kind==='freeze'){
  rotate(root,'upper_arm.R',-1.0,.1,-.38);rotate(root,'forearm.R',-.65);rotate(root,'hand.R',0,0,.12);rotate(root,'head',0,.15,-.10);rotate(root,'chest',0,-.14,.035);
 }else if(kind==='guard'){
  rotate(root,'upper_arm.L',-.72,.2,.40);rotate(root,'upper_arm.R',-.82,-.2,-.4);rotate(root,'forearm.L',-1.1);rotate(root,'forearm.R',-1.2);rotate(root,'head',.06,0,-.08);
 }else if(kind==='punch'){
